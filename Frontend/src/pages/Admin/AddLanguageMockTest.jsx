...
const AddLanguageMockTest = () => {
    ...
    const getNextMockTestNumber = async () => {
        try {
            const { data } = await axios.get(`${import.meta.env.SNOWPACK_PUBLIC_API}/language-mocktest/get-mocktest-number/${params.lang}`);
    ...
    const handleCreate = async (e) => {
        ...
        try {
            ...
            const { data } = await axios.post(
                `${import.meta.env.SNOWPACK_PUBLIC_API}/language-mocktest/add-mocktest/${params.lang}`,
